...
export class IndexCalcService {
  ...
  calcIndex(history: Score[]) {
    ...
    history.sort(
      (a, b) => Number(new Date(b.datePlayed)) - Number(new Date(a.datePlayed))
    ); //Sort player scores by date
    if (history.length > 20) history.slice(0, 20); // Take most recent 20 scores
    history[0].usgaIndexPrevious = history[1].usgaIndex;
    switch (
      history.length //history[0] is the player's most recent round
    ) {
      case 1:
        history[0].usgaIndex =
          Array.from(Object.values(history), (x) => x.usgaIndexForTodaysScore) //Create an array of score indexes
            .sort((a, b) => a - b) // Sort ascending - smallest first
            .slice(0, 1) //Take the lowest indices
            .reduce((a, b) => a + b, 0) - 4;
        console.log('history0', history[0].usgaIndex);
        break;
      case 2:
        history[0].usgaIndex =
          Array.from(Object.values(history), (x) => x.usgaIndexForTodaysScore) //Create an array of score indexes
            ...
            .slice(0, 1) //Take the  lowest indices
            .reduce((a, b) => a + b, 0) - 3;
        console.log('history1', history[0].usgaIndex);
        break;
      case 3:
        history[0].usgaIndex =
          Array.from(Object.values(history), (x) => x.usgaIndexForTodaysScore) //Create an array of score indexes
            ...
            .slice(0, 1) //Take the lowest indices
            .reduce((a, b) => a + b, 0) - 1;
        console.log('history2', history[0].usgaIndex);
        break;
      case 4:
        history[0].usgaIndex =
          Array.from(Object.values(history), (x) => x.usgaIndexForTodaysScore) //Create an array of score indexes
      ...
      case 6:
        history[0].usgaIndex =
          Array.from(Object.values(history), (x) => x.usgaIndexForTodaysScore) //Create an array of score indexes
            ...
            .reduce((a, b) => a + b, 0) /
            2 -
          1; //sum then average less adjustment
      ...
      case 11:
        history[0].usgaIndex =
          Array.from(Object.values(history), (x) => x.usgaIndexForTodaysScore)
            .sort((a, b) => a - b)
            .slice(0, 3)
            .reduce((a, b) => a + b, 0) / 3;
        break;
