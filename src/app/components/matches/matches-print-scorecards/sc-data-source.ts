...
export class SCDataSource extends DataSource<Results> {  // DataSource requires a connect and disconnect method

  constructor(private _strokes1Service: Strokes1Service) {   // injected service requires a call to super()
    super();
  }
